---
title: "Kaupungistumisen vaikutus syntyvyyteen"
...
# Analyysiä alueellisesta aineistosta

Pohjanmaalla, niin Etelä-, Keski- kuin Pohjois-Pohjanmaalla on syntyvyys ollut uusiutumistasolla. Tässä on nyt tapahtunut muutos, enää näin ei ole. 
...
Pyritään sitten arvioimaan miten hedelmällisyysluku kehittyy, mikäli 10 viime vuoden trendi jatkuisi näiden neljän tekijän osalta.
...
Meillä on nyt ennuste hedelmällisyysluvusta, joten käytetään sitä ja naisten lukumääriä arvioimaan lasten määriä
```{r, message = FALSE, warning = FALSE, echo=FALSE}
