...
ennuste_2022 <- predict(syntyvyys_reg_2022, syntyvyysaineisto_ennuste_2022,estimator="HPM")
...
ggplot(df,aes(x=vuosi))+geom_line(aes(y=hluku),color='black')+geom_line(aes(y=hedelmallisyysluku_ennuste),color="navyblue",linetype = "dashed") +geom_line(aes(y=alkuperainen),color="darkgreen",linetype = "dotdash") +scale_color_manual(name="Hedelmällisyysluku",labels=labels)+ theme_minimal() + ylab("Hedelmällisyysluku") + geom_text(x=2000, y=1.8, label="Havainto")+ geom_line(aes(y=hedelmallisyysluku_ennuste_2022),color="pink",linetype = "dashed")+ geom_text(x=2025, y=1.1, label="Ennuste 2023", color='navyblue')+ geom_text(x=2027, y=1.3, label="Ennuste 2018", color='darkgreen')+ylim(1.0,1.9)

ggplot(df,aes(x=vuosi))+geom_line(aes(y=hluku),color='black') +geom_line(aes(y=alkuperainen),color="darkgreen",linetype = "dotdash")+ xlab("Year")+ theme_minimal() + ylab("Total fertility rate") + geom_text(x=2000, y=1.8, label="Observation")+ geom_line(aes(y=hedelmallisyysluku_ennuste_2022),color="navyblue",linetype = "dashed")+ geom_text(x=2028, y=1.3, label="Forecast 2023", color='navyblue')+ geom_text(x=2028, y=1.1, label="Forecast 2018", color='darkgreen')+ylim(1.0,1.9)
