...
load("data/syntyvyysaineisto_CHECK2023_v2.RData")
```
...
syntyvyysaineisto_2023_redusoitu<-syntyvyysaineisto_2023[1:32,]
...
ennustelen<-enn[1]
print(dim(syntyvyysaineisto_2023))
```
...
kuten vaikkapa työllisyys tai taloudellinen tilanne. Jos sellaiset
tekijät vaikuttavat syntyvyyteen, vaikutuksen pitäisi näkyä
...
```{r, message = FALSE, warning = FALSE, echo=FALSE}
ennuste2023 <- predict(syntyvyys_reg, syntyvyysaineisto_2023,estimator="HPM")
...
Sovitetaa malli uuteeen dataan.

Päivitetääne nnuste vuonna 2023 kerätyllä datalla, joka loppuu vuoteen
2021.

```{r, message = FALSE, warning = FALSE, echo=FALSE}
syntyvyys_reg_2023 = bas.lm(hedelmallisyysluku ~lapsikuolleisuus + synnyttajien_keskiika + avioituvuus_naiset_25_29_lag1 + avioituvuus_naiset_30_34_lag1  + kehyskaupunki + sisempikaupunki + ulompikaupunki + some_25_34_lag1 + some_35_44_lag1, data = syntyvyysaineisto_2023_redusoitu,
prior = "ZS-null", modelprior = uniform())
syntyvyysaineisto_2023_redusoitu
```

```{r, message = FALSE, warning = FALSE, echo=FALSE}
syntyvyys_coef_2023=coef(syntyvyys_reg_2023,estimator="HPM")
syntyvyys_coef_2023
```

```{r, message = FALSE, warning = FALSE, echo=FALSE}
ennuste2023 <- predict(syntyvyys_reg_2023, syntyvyysaineisto_2023,estimator="HPM")
vuosi<-syntyvyysaineisto_2023$vuosi
hedelmallisyysluku<-ennuste2023$fit
hluku<-syntyvyysaineisto_ennuste$hedelmallisyysluku
#hluku<-syntyvyysaineisto$hedelmallisyysluku
