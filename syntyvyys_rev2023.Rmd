...
syntyvyysaineisto_redusoitu<-syntyvyysaineisto_redusoitu[2:34,]
...
syntyvyys_coef=coef(syntyvyys_reg,estimator="HPM")
syntyvyys_coef
syntyvyys_coef_bma=coef(syntyvyys_reg,estimator="B")
syntyvyys_coef_bma
```
...
df<-data.frame(vuosi,hfs,hedelmallisyysluku_ennuste,hluku,tfr_tk,tfr_hav,dummy2021[1:41])
...
print(syntyvyysaineisto_ennuste$naisten_lkm_15_19)
