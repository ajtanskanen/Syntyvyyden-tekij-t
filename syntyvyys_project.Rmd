...
```{r, message = FALSE, warning = FALSE , echo = FALSE}
dualplot(kaupungistumisdata$vuosi,kaupungistumisdata$hedelmällisyysluku,kaupungistumisdata$kaupungistuminen,ylab1="Hedelmällisyysluku",ylab2="Kaupungistuminen")
```
...
```{r}
syntyvyys_reg = bas.lm(hedelmallisyysluku ~pienituloisuus_0_17 + pienituloisuus_18_24 + pienituloisuus_25_34 + pienituloisuus_35_49 + pienituloisuus_50_64  + lapsikuolleisuus + tyollisyysaste_mies_30_34_lag1 + tyollisyysaste_nainen_30_34_lag1 + tyollisyysaste_mies_35_39_lag1 + tyollisyysaste_nainen_35_39_lag1 + tyollisyysaste_mies_25_29_lag1 + tyollisyysaste_nainen_25_29_lag1 + tyollisyysaste_mies_20_24_lag1 + tyollisyysaste_nainen_20_24_lag1 + synnyttajien_keskiika + avioliitot + avioerot + elakemeno + kaupungissaasuvat + maaseudulla + sisakaupungissa, data = syntyvyysaineisto_redusoitu,
prior = "ZS-null", modelprior = uniform())
```
...
```{r, message = FALSE, warning = FALSE, echo=FALSE}
keskiika_reg = bas.lm(synnyttajien_keskiika ~pienituloisuus_25_34   + lapsikuolleisuus + tyollisyysaste_nainen_25_29_lag1 + tyollisyysaste_nainen_30_34_lag1 + elakemeno + kaupungissaasuvat + maaseudulla + sisakaupungissa, data = syntyvyysaineisto_redusoitu,
prior = "ZS-null", modelprior = uniform())
```
